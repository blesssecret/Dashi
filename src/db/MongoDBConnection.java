...
public class MongoDBConnection implements DBConnection {
    ...
    private static String VISITED_TABLE = "visited";
    @Override
    public void setVisitedRestaurants(String userId, List<String> businessIds) {
    	db.getCollection("users").updateOne(new Document("user_id", userId),
      			 new Document("$pushAll", new Document(VISITED_TABLE, businessIds)));
    	//push all make it like linkedlist
    }

    @Override
    public void unsetVisitedRestaurants(String userId, List<String> businessIds) {
    	db.getCollection("users").updateOne(new Document("user_id", userId),
      			 new Document("$pullAll", new Document(VISITED_TABLE, businessIds)));
    	//pull all delete all the businessIds
    }
    ...
    public Set<String> getBusinessId(String category) {
    	Set<String> set = new HashSet<>();
    	// LIKE %category% in MySQL
    	// regex regular expresion MongoDB
      	 FindIterable<Document> iterable = db.getCollection("restaurants").find(
